...
public class QtumMainNetParams extends AbstractBitcoinNetParams {
    ...
    public QtumMainNetParams() {
        ...
        genesisBlock.setNonce(8026361L);

        id = ID_MAINNET;
        subsidyDecreaseBlockCount = 210000;
        spendableCoinbaseDepth = 100;
        //System.out.println(tx.getHashAsString());
        //checkState(genesisHash.equals("000075aef83cf2853580f8ae8ce6f8c3096cfa21d98334d6e3f95e5582ed986c"),genesisHash);
        ...
        dnsSeeds = new String[] {
                "localhost",         // Pieter Wuille
        };
        httpSeeds = new HttpDiscovery.Details[] {
                // Andreas Schildbach
                new HttpDiscovery.Details(
                        null,
                        URI.create("http://qtum3.dynu.net")
                )
        };
