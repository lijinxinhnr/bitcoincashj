...
public class Transaction extends ChildMessage {
    ...
    public TransactionOutput addOutput(long gasLimit, long gasPrice, byte[] dataHex,byte[] contractAddress) {
        return addOutput(new TransactionOutput(params, this, gasLimit, gasPrice, dataHex, contractAddress));
    }
     ...
     * @param anyoneCanPay should be false.
     */
    public Sha256Hash hashForSignatureBtc(int inputIndex, Script redeemScript,
                                       SigHash type, boolean anyoneCanPay) {
        int sigHash = TransactionSignature.calcSigHashValue(type, anyoneCanPay);
        return hashForSignatureBtc(inputIndex, redeemScript.getProgram(), (byte) sigHash);
    }
     ...
     */
    Sha256Hash hashForSignatureBtc(int inputIndex, byte[] connectedScript, byte sigHashType) {
